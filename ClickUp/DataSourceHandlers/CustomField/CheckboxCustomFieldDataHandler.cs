...
public class CheckboxCustomFieldDataHandler(InvocationContext invocationContext, [ActionParameter] TaskRequest task)
    : BaseCustomFieldDataHandler(invocationContext, task), IAsyncDataSourceItemHandler
{
    protected override string[] Types => ["checkbox"];

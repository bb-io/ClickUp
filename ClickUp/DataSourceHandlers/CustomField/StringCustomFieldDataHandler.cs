...
public class StringCustomFieldDataHandler(InvocationContext invocationContext, [ActionParameter] TaskRequest task)
    : BaseCustomFieldDataHandler(invocationContext, task), IAsyncDataSourceItemHandler
{
    protected override string[] Types => ["text", "short_text"];

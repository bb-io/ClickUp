...
public class LocationCustomFieldDataHandler(InvocationContext invocationContext, [ActionParameter] TaskRequest task)
    : BaseCustomFieldDataHandler(invocationContext, task), IAsyncDataSourceItemHandler
{
    protected override string[] Types => ["location"];
